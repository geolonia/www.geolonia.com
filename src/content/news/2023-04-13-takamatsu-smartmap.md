...
![スマートマップ概要](/images/news/2023-04-13-takamatsu-smartmap-1.webp)
*スマートマップ概要*
...
**1)高松市スマートマップ**  
[https://maps.takamatsu-fact.com/](https://maps.takamatsu-fact.com/)  
高松市の都市計画、道路・鉄道、用途区分、施設、センサーのデータを確認できる地図サイトです。地図とデータはAPIとして提供され、地図を使ったアプリケーションやサービスを開発できます。

![高松市スマートマップ](/images/news/2023-04-13-takamatsu-smartmap-2.webp)
*高松市スマートマップ*

**2)高松市スマートマップ & 都市情報API 開発者向けドキュメンテーション**  
[https://docs.takamatsu-fact.com/](https://docs.takamatsu-fact.com/)  
ウェブサイトやウェブアプリケーションの開発者向けに、地図とAPIの利用方法を説明しているマニュアルサイトです。  

**3)高松市 GitHub Organization**  
[https://github.com/takamatsu-city/](https://github.com/takamatsu-city/)  
...
![GitHubオーガニゼーション](/images/news/2023-04-13-takamatsu-smartmap-3.webp)
*GitHubオーガニゼーション*

**4)たかまつマイセーフティーマップ**  
[https://safetymap.takamatsu-fact.com/](https://safetymap.takamatsu-fact.com/)  
...
![たかまつマイセーフティーマップ](/images/news/2023-04-13-takamatsu-smartmap-4.webp)
*たかまつマイセーフティーマップ*
