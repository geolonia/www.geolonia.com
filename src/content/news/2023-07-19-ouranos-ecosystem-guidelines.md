...
株式会社Geoloniaはこのたび、経済産業省が推進する「Ouranos Ecosystem（ウラノス・エコシステム）」に関する検討会に参加し仕様の策定に協力、共通ライブラリ「Ouranos GEX（[https://github.com/ouranos-gex](https://github.com/ouranos-gex)）」の開発を担当いたしました。
...
また同取り組みの一環として、4次元時空間情報基盤を実装するための各種ツール類を共創するための共通ライブラリ「Ouranos GEX（[https://github.com/ouranos-gex](https://github.com/ouranos-gex)）」の開発を担当、提供しています。
...
[https://www.meti.go.jp/policy/mono\_info\_service/digital\_architecture/ouranos.html](https://www.meti.go.jp/policy/mono_info_service/digital_architecture/ouranos.html)
...
\*「Ouranos GEX」[https://github.com/ouranos-gex](https://github.com/ouranos-gex)
